...
public:
  ...
  (double sigma,		// transverse error on track at intersection
   const CLHEP::Hep3Vector& direction,	// track direction
   const CLHEP::Hep3Vector& uHat,	// direction of local coordinate u
   const CLHEP::Hep3Vector& vHat,	// direction of local coordinate v
   CLHEP::HepSymMatrix& error);	// error matrix projected on u-v plane

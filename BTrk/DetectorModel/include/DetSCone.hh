...
//
  ...
  virtual Hep3Vector normal( const SurfacePoint&) const;
  virtual Hep3Vector surfaceDirection( const SurfacePoint& sp, int indx) const;
...
private:
  ...
  inline coneRegion theRegion(const Hep3Vector&, // input point

...
TrkLineTraj::TrkLineTraj(const HepPoint& point, const Hep3Vector& direction,
                        double length) :
...
TrkLineTraj::TrkLineTraj(const HepPoint& point1, const HepPoint& point2)
  : TrkGeomTraj(0.0,point1.distanceTo(point2)), _start(point1)
{
...
void
TrkLineTraj::getInfo(double fltLen, HepPoint& pos, Hep3Vector& dir) const
{
  pos = position(fltLen);
...
void
TrkLineTraj::getInfo(double fltLen, HepPoint& pos, Hep3Vector& dir,

...
public:
  ...
  virtual CLHEP::Hep3Vector        direction(double fltL)        const = 0;
  virtual CLHEP::Hep3Vector        momentum(double fltL=0.)      const = 0;

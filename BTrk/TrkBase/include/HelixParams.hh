...
public:
  ...
  HelixParams(const HepVector&, const HepSymMatrix&);
  ~HelixParams();
  ...
  const HepVector& params() const                {return parvec;}
  HepVector& params()                            {return parvec;}
  ...
  void setError(const HepSymMatrix& in)          {parcov = in;}

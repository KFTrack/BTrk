...
public:
  ...
  inline const CLHEP::HepVector derivs() const;     //deriv of doca w/r/t track params
  inline void fetchDerivs(CLHEP::HepVector&) const;   // faster version
...
const CLHEP::HepVector TrkDifPoca::derivs() const         {return _doca.derivatives();}
void TrkDifPoca::fetchDerivs(CLHEP::HepVector& dv) const {_doca.fetchDerivatives(dv);}
#endif

...
//  Change in param WRT change in direction 
  virtual CLHEP::HepMatrix derivDeflect(double fltlen,deflectDirection idir) const = 0;
...
// effect of multiple scattering, only substantial for thick materials
  virtual CLHEP::HepMatrix derivDisplace(double fltlen,deflectDirection idir) const = 0;
//  Similair function for the parameter change WRT change in fractional momentum
  virtual CLHEP::HepMatrix derivPFract(double fltlen) const = 0;

...
public:
  ...
  BFieldIntegrator(const BField &bField,BFieldIntConfig const& config,const CLHEP::Hep3Vector& bnom);

  //destroy
  virtual ~BFieldIntegrator();

  //integrate
  CLHEP::Hep3Vector deltaMomentum
...
// subdivide a range
 ...
 // accessors 
  ...
  const CLHEP::Hep3Vector& nominalField() const { return _bNominal; }
...
private:
  ...
  CLHEP::Hep3Vector _bNominal;		// nominal field

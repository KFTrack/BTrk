...
export PACKAGE_VERSION=v1_02_37
export COMPILER_CODE=e20
export EXTRA_ROOT_QUALIFIERS=":p3913"
...
setup -B clhep v2_4_5_3a -q${qualifiers}
setup -B root  v6_26_06  -q${qualifiers}${extras}
setup -B scons v4_4_0    -q p3913
